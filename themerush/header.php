...
<?php $layout_option ='';if(is_front_page() || is_home()) { if(of_get_option('home_page_layout') == '2c-r-fixed') {$layout_option ='two-columns-layout';}else{$layout_option ='three-columns-layout';}}
elseif(is_single()) { if(of_get_option('post_layout') != '2c-r1-fixed'){ $layout_option ='two-columns-layout';}else{$layout_option ='three-columns-layout';}}
elseif(is_page() || is_category() || is_archive()) { if(of_get_option('cat_layout') != '2c-r1-fixed'){ $layout_option ='two-columns-layout';}else{$layout_option ='three-columns-layout';}}
 ?> 
   
<div class="container-wrap <?php echo $box_design;?> <?php echo $layout_option;?>">
