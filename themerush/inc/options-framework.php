...
function optionsframework_load_styles() {
	...
	wp_enqueue_style('iphone-style', OPTIONS_FRAMEWORK_DIRECTORY.'css/iphone.css');
...
function optionsframework_load_scripts( $hook ) {
    ...
    wp_enqueue_script('iphone-style-js', OPTIONS_FRAMEWORK_DIRECTORY.'js/iphone-style-checkboxes.js', array('jquery'));
...
function optionsframework_page() {
	settings_errors(); 
    $imagepath =  get_stylesheet_directory_uri() . '/inc/images/';
	?>
...
echo '<h2><a href="'.$my_theme->get( 'ThemeURI' ).'">'.$my_theme->{'Name'}."</a></h2>";
echo "<p>".$my_theme->{'Description'}."<p>";
echo "<p class='version'>Version: ".$my_theme->{'Version'}."<p>";
?>
</div>
